import styles from '../../styles/module/privacyPolicy.module.css';
import commonStyles from '../../styles/module/common.module.css';

const PrivacyPolicyPage = () => {
    return (
        <>
            <main className={commonStyles.fs16}>
                <div className={styles.privacyPolicyContainer}>
                    <nav className={commonStyles.breadcrumb}>
                        <span>トップ — プライバシーポリシー</span>
                    </nav>
                    <h1 className={styles.pageTitle}>プライバシーポリシー</h1>
                    <section>
                        <p className={styles.policyText}>
                            東京ブッシュクラフト（以下，「当社」といいます。）は，本ウェブサイト上で提供するサービス（以下,「本サービス」といいます。）における，
                    ...
                    <section>
                        ...
                        <p className={styles.policyText}>
                            ...
                            電話番号，連絡先その他の記述等により特定の個人を識別できる情報及び容貌，
                    ...
                    <section>
                        ...
                        <p className={styles.policyText}>
                            ...
                            メールアドレス，銀行口座番号，クレジットカード番号，運転免許証番号などの
                            個人情報をお尋ねすることがあります。また，ユーザーと提携先などとの間で
                            なされたユーザーの個人情報を含む取引記録や決済に関する情報を,当社の提携先
                            （情報提供元，広告主，広告配信先などを含みます。以下，｢提携先｣といいます。）などから
                            収集することがあります。
                        </p>
                    </section>
                    <section>
                    ...
                    <section>
                        ...
                        <p className={styles.policyText}>
                            ...
                            変更後の目的について，当社所定の方法により，ユーザーに通知し，または本ウェブサイト上に
                            公表するものとします。
                        </p>
                    </section>
                    <section>
                        ...
                        <p className={styles.policyText}>
                            ...
                            第三者に個人情報を提供することはありません。ただし，個人情報保護法その他の法令で
                            認められる場合を除きます。
                        </p>
                        <ul className={styles.policyText}>
                    ...
                    <section>
                        ...
                        <p className={styles.policyText}>
                            ...
                            当社が定める手続きにより，当社に対して個人情報の訂正，追加または削除（以下，「訂正等」といいます。）を
                            請求することができます。当社は，ユーザーから前項の請求を受けてその請求に応じる必要があると
